...
const routes: Routes = [
  ...
  { path: 'vendeur', component: VendeurComponent, canActivate: [AuthGuardService] }, // Bloque l'accès à la page "Vendeur" pour les utilisateurs sans le rôle "admin"
  { path: 'acheter', component: AcheterComponent, canActivate: [AuthGuardService] },
];
